...
const KNOWN_IOS_ZH_VOICES: Omit<VoiceEntry, 'installed'>[] = [
  ...
  // default voice 
  { identifier: 'com.apple.voice.compact.zh-CN.Tingting', name: '婷婷', language: 'zh-CN', quality: 'Default', description: '普通话', gender: 'female' },
  { identifier: 'com.apple.voice.compact.zh-TW.Meijia',    name: '美佳', language: 'zh-TW', quality: 'Default', description: '台湾腔调', gender: 'female'   },
  // english voices
...
const AVATAR_MAP: Record<string, ReturnType<typeof require>> = {
  x4_yezi:    require('../../assets/avatar/x4_yezi.png'),
  x4_xiaoyan: require('../../assets/avatar/x4_xiaoyan.png'),
  xiaoyu:     require('../../assets/avatar/xiaoyu.png'),
  "com.apple.voice.premium.zh-CN.Yun":   require('../../assets/avatar/yun.png'),
  "com.apple.voice.premium.zh-CN.Yue":  require('../../assets/avatar/yue.png'),
  "com.apple.voice.premium.zh-CN.Han": require('../../assets/avatar/han.png'),
};

export function getVoiceAvatar(identifier: string, gender?: 'male' | 'female' | 'neutral') {
  if (AVATAR_MAP[identifier]) return AVATAR_MAP[identifier];
  return gender === 'male'
