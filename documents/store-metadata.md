...
• **Auto Page Flip** — Set a timed interval and the app flips pages automatically — perfect for hands-free listening.
...
| 设备 | 尺寸 | 数量要求 |
|------|------|----------|
| iPhone 6.9"（iPhone 16 Pro Max）| 1320×2868 px | 最少1张，建议4-5张 |
| iPhone 6.5"（iPhone 14 Plus 等）| 1242×2688 px | 最少1张 |
| iPad Pro 13"（如有）| 2064×2752 px | 如需上架 iPad |

**建议截图内容（按顺序）：**
1. 书架页 — 展示有几本书的状态
2. 阅读页（日间主题）— 展示正文 + 底部控制栏
3. 阅读页（夜间主题）— 体现主题切换
4. 章节目录页
5. 导入书籍页
...
| 类型 | 尺寸 | 说明 |
|------|------|------|
| 手机截图 | 最小 1080×1920 px | 至少2张，建议4-8张，内容同上 |
| Feature Graphic | 1024×500 px | 必须提供，建议放 Logo + Slogan |
| 平板截图（可选）| 1200×1920 px | 如需上架平板优化版 |
