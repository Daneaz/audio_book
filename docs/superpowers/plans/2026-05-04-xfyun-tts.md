...
| `src/i18n/translations.ts` | Modify | Add `voice.cloud`, `settings.clearVoiceCache`, `settings.xfyunCacheSize` |
...
```typescript
    'voice.cloud': '云端',
    'settings.clearVoiceCache': '清除讯飞语音缓存',
...
```typescript
    'voice.cloud': 'Cloud',
    'settings.clearVoiceCache': 'Clear iFlyTek Cache',
